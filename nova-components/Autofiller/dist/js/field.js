...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    onChange: function onChange(event) {
      ...
      Nova.$emit(this.getFieldAttributeValueEventName('email_body'),
      // the name of the event is randomised on every page load, that's why you need to use this function to determine it.
      ...
      for (var pos in this.field.modelworld) {
        if (this.field.modelworld[pos]['id'] == event.target.value) {
          ...
          for (var key in this.field.modelworld[pos]) {
            var value = this.field.modelworld[pos][key];
            ...
            if (key == 'copy') {
              Nova.$emit(this.getFieldAttributeValueEventName('copy'),
              // the name of the event is randomised on every page load, that's why you need to use this function to determine it.
              value);
            }
            if (key != 'id' && key != 'template_null' && key != 'email_body' && key != 'created_at' && key != 'copy' && key != 'updated_at' && key != 'mms_image' && key != 'cooked' && key != 'campaign_ready' && key != 'created_at' && key != 'author_id' && key != 'template') {
              ...
              Nova.$emit(this.getFieldAttributeValueEventName(key),
              // the name of the event is randomised on every page load, that's why you need to use this function to determine it.
              value);
            }
          }
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultField, {
    ...
    field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      ...
      }, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($props.field.modelworld, function (option) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
          value: option.id,
          type: "select"
        }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(option.headline), 9 /* TEXT, PROPS */, _hoisted_1);
      }), 256 /* UNKEYED_FRAGMENT */))], 544 /* HYDRATE_EVENTS, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $data.selected]])];
    }),
    _: 1 /* STABLE */
...
Nova.booting(function (app, store) {
  app.component('index-autofiller', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-autofiller', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-autofiller', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
...
/* harmony import */ var _Users_kostakondratenko_Dropbox_larapi_nova_components_Autofiller_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_Users_kostakondratenko_Dropbox_larapi_nova_components_Autofiller_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_DetailField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_DetailField_vue_vue_type_template_id_0224618e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/DetailField.vue"]])
/* hot reload */
if (false) {}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkkostasmatrix_autofiller"] = self["webpackChunkkostasmatrix_autofiller"] || [];
