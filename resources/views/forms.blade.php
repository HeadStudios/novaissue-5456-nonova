...
<html lang="en" class="h-full bg-gray-50">
  <head>
    ...
    <meta name="twitter:description" content="Login and registration form examples for Tailwind CSS, designed and built by the creators of the framework." />
    ...
    <meta property="og:description" content="Login and registration form examples for Tailwind CSS, designed and built by the creators of the framework." />
    <meta property="og:image" content="https://tailwindui.com/img/og-image.png" />
    <meta property="description" content="Login and registration form examples for Tailwind CSS, designed and built by the creators of the framework." />
    <meta name="csrf-token" content="CONSTANT_TOKEN" />
    <link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png" />
    <link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png" />

    <link rel="preload" href="/fonts/Inter-roman.var.woff2?v=3.18" as="font" type="font/woff2" crossorigin />
    <link rel="stylesheet" href="http://127.0.0.1:8000/build/assets/app.3c260bd1.css" />
    <title>Sign-in and Registration - Official Tailwind CSS UI Components</title>
        <script>
