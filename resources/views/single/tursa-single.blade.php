...
<div class="text-lg max-w-prose mx-auto mt-5 mb-16 prose">
      ...
      {!! Str::markdown($campaign->copy) !!}
        ...
        <div class="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-5 lg:text-left bg-gray-50 p-4 rounded-lg">
            <div>
          <h1>
            <span class="block text-sm font-semibold uppercase tracking-wide text-gray-500 sm:text-base lg:text-sm xl:text-base bg-black text-white	inline p-2">ATTENTION: Property Managers</span>
            <span class="mt-1 block text-3xl tracking-tight font-extrabold sm:text-3xl xl:text-3xl">
            Want to get <span class="block text-indigo-600 contents decoration-4 underline"><u class="underline decoration-rose-700">10+ New Properties</u> Under Contract</span> In the <span class="block text-indigo-600 contents">First <u class="decoration-4 underline decoration-rose-700">30 Days</u></span> WITHOUT Paying for Ads - <span class="block text-indigo-600 bg-emerald-50 inline decoration-4 underline decoration-rose-700">GUARANTEED</span>
              <!--<span class="block text-gray-900">Get your </span>
              <span class="block text-indigo-600">Free Rent Roll Growth Automation</span>
              <span class="block text-gray-900">System</span>-->
            </span>
          </h1>
          <p class="mt-3 mb-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">I'm so confident in my system (after the success with growing a property management company by $25 million managements) that I can offer you an additional 10 managements to your agency in your first 30 days GUARANTEED or you get my program for FREE. </p>
          <p class="mt-3 mb-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">To see if you qualify book your "good fit" appointment by entering your details below.</p>
