  ...
  <div class="sm:rounded-bl-lg relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500">
    ...
    <div class="mt-8">
      <h3 class="text-lg font-medium">
        <a href="{{ route('course', ['perma' => $course->permalink]) }}" class="focus:outline-none">
          <span class="absolute inset-0" aria-hidden="true"></span>
          {{ $course->name}}
        </a>
      </h3>
      <p class="mt-2 text-sm text-gray-500">Status: @if ($course->isCompletedBy($user)) COMPLETE! @else DO IT! @endif</p>
