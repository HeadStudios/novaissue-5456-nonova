...
@if (session()->has('message'))
  ...
  <div class="max-w-md w-full space-y-8">
    <div>
      <img class="mx-auto h-12 w-auto" src="{{ asset('plain-assets/logos/small_tiger_vial.png') }}" alt="Workflow">
    ...
    <form class="mt-8 space-y-6">
      ...
      <div>
        <button wire:click.prevent="login" class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
