...
class Campaign extends Resource
{
    ...
    public function fields(NovaRequest $request)
    {
        ...
        return [
            ...
            BelongsTo::make('Author', 'author', 'App\Nova\User')->searchable()->hideFromIndex()->canSee(function ($request) {
                return $request->user()->hasRole('admin');
            }),
            ...
            Text::make('Permalink', 'permalink')->canSee(function ($request) {
                return $request->user()->hasRole('admin');
            }),
            ...
            DependablePanel::make('Landing Page Fields', [
                ...
                Markdown::make('Copy', 'copy')->hideFromIndex(),
